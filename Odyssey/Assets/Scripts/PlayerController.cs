...
public class PlayerController : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		currentPos = new Vector2 (playerTransform.position.x, playerTransform.position.y);
		projectedPos = new Vector2 (playerTransform.position.x, playerTransform.position.y);
